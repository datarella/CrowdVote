...
class App extends React.Component {
    constructor(props){
        ...
        if(typeof web3 != 'undefined'){
            ...
            this.web3 = new Web3(new Web3.providers.HttpProvider("https://ropsten.infura.io/v5tOnAp5nwYa4qqIdZU0"))
        }
        ...
        this.state.ContractInstance = MyContract.at("0x8d8d90ed25f915448af448e000da8a1e0b7dcf88")
    }
...
// Remove the other number selected
    ...
    render(){
        return (
            ...
            <h1>Bet for your best banana and win huge amounts of Ether</h1>
